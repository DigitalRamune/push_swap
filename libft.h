...
void					lstclear_all(t_list **st_a, t_list **st_b,
							t_para **param, t_oper **op);
...
void					ft_reverserotate(t_list **stack_a, t_oper **operation,
							int which);
void					ft_rrr(t_list **stack_a, t_list **stack_b,
							t_oper **operation);
void					ft_rotate(t_list **stack_a, t_oper **operation,
							int which);
void					ft_rr(t_list **stack_a, t_list **stack_b,
							t_oper **operation);
void					ft_push(t_list **stack_a, t_list **stack_b,
							t_oper **operation, int which);
void					ft_swap(t_list **stack_a, t_oper **operation,
							int which);
...
void					ft_sort_small(t_list **st_a, t_list **st_b,
							t_oper **op);
...
int						find_min_score(t_list **stack_a, int index_score,
...
void					place_max_at_top(t_list **next_p, int index,
							t_oper **operation);
void					order_alg(int temp_min_data, t_list **st_a,
							t_list **st_b, t_oper **op);
...
void					ft_push_back_all(t_list **st_b, t_list **st_a,
							int count, t_oper **op);
...
void					print_bench(t_para **param, t_oper **op,
							float disorder);
void					ft_bench(t_oper **op, t_para **param, t_list **stack_a,
							t_list **stack_b);

void					ft_create_stack(t_list **stack_a, char **argv, int i,
							int z);
void					ft_init(t_list **st_a, t_list **st_b, t_oper **op,
							t_para **param);
